...
const HeroSection = () => {
  return (
    <div
      className="bg-cover bg-center h-screen flex flex-col items-center justify-center gap-2"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="bg-white w-[80vw] p-5 rounded-md flex flex-col md:flex-row justify-between mb-8">
        <HeroSearch />
      </div>
