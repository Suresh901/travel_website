...
const Opportunity = () => {
  return (
    <div className="flex flex-col lg:flex-row lg:mx-10 xl:mx-20 gap-10 my-10 ">
      <div className="w-full xl:w-1/2 grid grid-cols-2 items-center gap-10 p-5">
        <div>
          <img
      ...
      <div className="w-full xl:w-1/2 lg:mx-10 relative p-5">
        <div className="">
          <Heading
            heading="Who We Are"
            title={`Great opportunity for adventure & travels`}
          />
        </div>

        <div className="pb-10 flex flex-col gap-5 mt-10 ">
          <div className="w-[1px] h-48 lg:h-60 border border-dashed absolute left-[5.5rem] top-[12.5rem] md:left-[6.2rem] md:top-[12.5rem] lg:top-[17.5rem]"></div>
          ...
          <div className="flex gap-5 md:gap-10">
            ...
            <div className="flex flex-col justify-between gap-10">
              <div>
                ...
                <h1 className="text-text text-[10px] md:text-[16px]">
